  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>To send periodic emails regarding your order or other products
          and services.</li>
      </ul>
      <h2 className="text-2xl font-bold mb-2">
      ...
      <p className="mb-4">
        ...
        card numbers. We use regular Malware Scanning.
      </p>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-bold mb-2">Do we use &apos;cookies&apos;?</h2>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-bold mb-2">We use cookies to:</h3>
      <ul className="list-disc list-inside mb-4">
      ...
      <h2 className="text-2xl font-bold mb-2">Google</h2>
      <p className="mb-4">
...
-        Internet. Users may opt-out of the use of the DART cookie by visiting
      ...
      <h2 className="text-2xl font-bold mb-2">COPPA (Children Online Privacy
        Protection Act)</h2>
      <p className="mb-4">
        ...
        the COPPA Rule, which spells out what operators of websites and
      ...
      <h2 className="text-2xl font-bold mb-2">Fair Information Practices</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-bold mb-2">CAN SPAM Act</h2>
      <p className="mb-4">
