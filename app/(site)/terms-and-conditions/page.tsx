...
export const metadata: Metadata = {
  ...
  description:
    "This is the terms and conditions for our website. Please read it carefully.",
};
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>
          ...
          Agreement) refers to [Your Company Name], [Your Company Address].
        </li>
        <li>
      ...
      <ul className="list-disc list-inside mb-4">
        ...
        <li>Last Update: [Your Phone Number]</li>
      </ul>
    </div>
  );
};
